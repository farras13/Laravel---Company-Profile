...
@section('content')
    <div class="card">
        ...
        <div class="card-body table-responsive p-0" style="height: 400px;">
            <form action="{{ url('page/update').'/'.$data->id }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Section Pages</label>
                        <input type="text" class="form-control" id="inputSection" name="section" value="{{ $data->section }}" readonly>
                    </div>
                    <div class="form-group">
